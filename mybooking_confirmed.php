    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-lg-8 pb-5">
                <!-- Item-->
                <?php
                    $qrygetBooking=mysqli_query($conn,"SELECT * FROM booking WHERE tourist='$data1[tourist_id]' AND status='3'");
                                    ...
                                    <span>Status: <span class="text-success font-weight-medium">
                                        <?php
                                            if($qrygetBooking_run['status']=='0'){
                                                ...
                                                echo 'Confirmed<br>';
                                                echo '<a href="travel_details.php?print='.$qrygetBooking_run['booking_id'].'" " style="font-size: 14px; color: green" target="_blank">Print travel details</a><br>';
                                                echo ' <a href="rating_review.php?on='.$qrygetDestination_run['destination_id'].'" style="font-size: 14px; color: green">Review</button></a>';
                                            }elseif($qrygetBooking_run['status']=='4'){
                                                echo 'In-progress';
                                            }else{
                                                echo 'Completed';
                                                echo ' <a href="rating_review.php?on='.$qrygetDestination_run['destination_id'].'" style="font-size: 14px; color: red">Review</button></a>';
                                            }
