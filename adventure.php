            ...
            <div class="container py-5">
                <div class="row justify-content-center py-5">
                    <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                        <h1 class="display-3 text-white animated slideInDown">Tungawan Exploration</h1>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                <li class="breadcrumb-item active"><a href="javascript:;">Explore</a></li>
                                <li class="breadcrumb-item text-white active" aria-current="page">Adventure</li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <div class="container-xxl py-5 destination">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">Explore our adventure</h1>
            </div>
            <div class="row g-3">
                <?php
                    $sql = mysqli_query($conn, "SELECT * FROM destination WHERE status = 1 AND category = 3 ORDER BY RAND() ");
