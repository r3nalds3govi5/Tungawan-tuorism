            ...
            <div class="container py-5">
                <div class="row justify-content-center py-5">
                    <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                        <h1 class="display-3 text-white animated slideInDown">Book your desired destination</h1>
    ...
    <div class="container-xxl py-5 destination">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <?php
                    $sql1 = "SELECT * FROM destination WHERE status = 1 AND category != 4 AND category != 5 AND category != 3 AND destination_id !='TID20230814-8' LIMIT 0, 9";
                    $result1 = mysqli_query($conn, $sql1);
                    $nopb = mysqli_num_rows($result1);
                ?>
                <h4 class=" bg-white text-center text-primary px-3 mb-5">There are (<?= $nopb; ?>) awsome places to book.</h4>
                <!-- <h1 class="mb-5">Our Visitors Say!!!</h1> -->
            </div>
            <div class="row g-3">
                <?php

                    $sql = "SELECT * FROM destination WHERE status = 1 AND category != 4 AND category != 5 AND category != 3 AND destination_id !='TID20230814-8' ORDER BY RAND() LIMIT 0, 9";
                    ...
                    $disid = $data['destination_id'];
                ?>
                    <div class="col-lg-4 col-md-12 wow zoomIn" data-wow-delay="0.1s">
                        <a class="position-relative d-block overflow-hidden" href="booking_destination.php?on=<?php echo $data['id']; ?>">
                            <img class="img-fluid" src="admin/uploads/<?= $data['image']; ?>" alt="" style="height: 30vh !important">
                            ...
                            <div class="bg-white text-primary fw-bold position-absolute bottom-0 end-0 m-3 py-1 px-2">
                                <i class="fa fa-map-marker-alt me-1"></i><?= $data['destination']; ?>
                            </div>
                        </a>
                    </div>
                <?php } ?>
    ...
    <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel position-relative">
                <?php
                    $sql = $conn->query("SELECT *, SUBSTRING(review, 1, 30) AS review FROM destination_ratings");
