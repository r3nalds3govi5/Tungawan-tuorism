    ...
    <div class="container-xxl py-5 destination">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-primary px-3 mb-5">Ratings & Reviews</h6>
                <!-- <h1 class="mb-5">Our Visitors Say!!!</h1> -->
            </div>
            <div class="row g-3">
                <?php

                    $sql = "SELECT * FROM destination WHERE status = 1 LIMIT 0, 9";
                ...
                ?>
                    <div class="col-lg-4 col-md-12 wow zoomIn" data-wow-delay="0.1s">
                        <a class="position-relative d-block overflow-hidden" href="rating_review.php?on=<?php echo $data['destination_id']; ?>">
