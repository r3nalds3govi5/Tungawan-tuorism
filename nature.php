            ...
            <div class="container py-5">
                <div class="row justify-content-center py-5">
                    <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                        <h1 class="display-3 text-white animated slideInDown">Explore the beauty of nature</h1>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                <li class="breadcrumb-item active"><a href="javascript:;">Explore</a></li>
                                <li class="breadcrumb-item text-white active" aria-current="page">Nature</li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <div class="container-xxl py-5 destination">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-primary px-3">Nature</h6>
                <h1 class="mb-5">Explore the beauty of Tungawan</h1>
            </div>
            <div class="row g-3">
                <?php
    ...
    <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel position-relative">
                <?php
                    $sql = $conn->query("SELECT *, SUBSTRING(review, 1, 100) AS reviews FROM destination_ratings");
                ...
                ?>
                    <div class="testimonial-item bg-white text-center border p-4">
                        ...
                        <p class="mb-0" style="font-size: 13px;"><i>"<?=  $sqlLoad['reviews']; ?>"</i></p>
                    </div>
                <?php } ?>                                        
            </div>
        </div>
