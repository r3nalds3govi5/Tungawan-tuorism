        ...
        <?php 
            if($statushere=='positive'){ 
                ...
                if(isset($_GET['confirm'])){
                    $get_id = $_GET['confirm'];
                    mysqli_query($conn, "UPDATE `booking` SET status = 3 WHERE booking_id = '$get_id'");
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-lg-4 pb-5">
                ...
                <div class="wizard">
                    <nav class="list-group list-group-flush">
                        <a class="list-group-item" href="mybooking.php">
            ...
            <div class="col-lg-8 pb-5">
                <!-- Item-->
                <?php
                    $qrygetBooking=mysqli_query($conn,"SELECT * FROM booking WHERE tourist='$data1[tourist_id]' AND status='1'");
                                ...
                                <span>Status: <span class="text-success font-weight-medium">
                                    <?php
                                        if($qrygetBooking_run['status']=='0'){
                                            ...
                                            echo 'Approved<br>';
                                             echo '<a href="mybooking_approved.php?confirm='.$qrygetBooking_run['booking_id'].'" onclick="return confirm(\'Are you sure you want to cpnfirm this booking?\')" style="font-size: 14px; color: red">Please confirm your booking</a><br>';
                                             echo '<a href="travel_details.php?print='.$qrygetBooking_run['booking_id'].'" " style="font-size: 14px; color: green" target="_blank">Print travel details</a>';
