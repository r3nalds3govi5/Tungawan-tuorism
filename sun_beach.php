            ...
            <div class="container py-5">
                <div class="row justify-content-center py-5">
                    <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                        <h1 class="display-3 text-white animated slideInDown">Explore the beautiful beaches of Tungawan</h1>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                <li class="breadcrumb-item"><a href="#">Explore</a></li>
                                <li class="breadcrumb-item text-white active" aria-current="page">Sun & Beach</li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <div class="container-xxl py-5 destination">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-primary px-3">Sun & Beach</h6>
                <h1 class="mb-5">Our Beaches</h1>
            </div>
            <div class="row g-3">
                <?php
                    $sql = mysqli_query($conn, "SELECT * FROM destination WHERE status = 1 AND category = 2 ORDER BY RAND()");
